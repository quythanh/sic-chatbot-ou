...
{/* <div className={(style1 as any)['spinner-box']}>
  <div className={(style1 as any)['pulse-container']}>  
    <div className={(style1 as any)['pulse-bubble pulse-bubble-1']}></div>
    <div className={(style1 as any)['pulse-bubble pulse-bubble-2']}></div>
    <div className={(style1 as any)['pulse-bubble pulse-bubble-3']}></div>
  </div>
</div> */}
{/* 
<div className={(style1 as any)['spinner-box']}>
